...
def preprocess_dataset_mrpc(path, is_test_set=False):
    ...
    for line in open(path, 'r', encoding='utf-8'):
        if n == 0:
            n += 1 
            continue
        label, id1, id2, warrant0, warrant1 = line.strip().split('\t')
        if label != '1' and label != '0':
            continue
        #print(reason)
        #print(warrant0, warrant1, label)
        d_dict = tokenize(warrant0)
        q_dict = tokenize('mrpcdata')
...
if __name__ == '__main__':
    ...
    preprocess_dataset_mrpc('/home/hd_1T/haiou/newdata/data/MRPC/msr_paraphrase_train.txt')
    preprocess_dataset_mrpc('/home/hd_1T/haiou/newdata/data/MRPC/msr_paraphrase_test.txt')
