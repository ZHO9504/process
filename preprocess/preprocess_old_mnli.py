...
def preprocess_dataset_mnli(path, is_test_set=False):
    start_time = time.time()
    writer = open(path  + '-processed_11_26.json', 'w', encoding='utf-8') 
    n = 0
    ex_cnt = 0
    for line in open(path, 'r', encoding='utf-8'):
        ...
        warrant0, warrant1, label = line.strip().split('\t')
        if label == 'neutral':
            label = '0'
        if label == 'entailment':
            label = '1'
        if label == 'contradiction':
            label = '2'
        #print(reason)
        #print(warrant0, warrant1, label)
        d_dict = tokenize(warrant0)
        q_dict = tokenize('mnlidata')
        c_dict = tokenize(warrant1)
...
if __name__ == '__main__':
    ...
    preprocess_dataset_mnli('/home/hd_1T/haiou/newdata/data/multinli_1.0/mnli_train.txt')
    preprocess_dataset_mnli('/home/hd_1T/haiou/newdata/data/multinli_1.0/mnli_dev_matched.txt')
    preprocess_dataset_mnli('/home/hd_1T/haiou/newdata/data/multinli_1.0/mnli_dev_mismatched.txt')
