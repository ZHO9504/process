...
def preprocess_dataset_sciq(path, is_test_set=False):
    ...
    with open(path, 'r') as json_file:
        ...
        for obj in data:
            ...
            c_dicts.append(tokenize(obj['distractor3']))
            c_dicts.append(tokenize(obj['distractor2']))
            c_dicts.append(tokenize(obj['distractor1']))
            c_dicts.append(tokenize(obj['correct_answer']))
            example = get_example(d_id + '_' + str(0), d_dict, q_dict, c_dicts,'3')
