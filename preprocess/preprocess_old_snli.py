...
def preprocess_dataset_snli(path, is_test_set=False):
...
if __name__ == '__main__':
    ...
    preprocess_dataset_snli('/home/hd_1T/haiou/newdata/data/snli_1.0/dev.txt')
    preprocess_dataset_snli('/home/hd_1T/haiou/newdata/data/snli_1.0/train.txt')
